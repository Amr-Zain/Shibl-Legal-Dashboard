...
import type { QuestionResponse, SectionResponse, ServiceReaspose, WhyUsResponse } from "@/util/responsesTypes";
...
export const formateKeyFeatureForm = (feature: WhyUsResponse) => {
  return {
    id: feature.id,
...
export const  formatServiceForm = (service: ServiceReaspose) => ({
    id: service.id,
