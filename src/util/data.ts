...
export const sections: { type: BannerTypes, text: string }[] = [
  { type: 'about', text: 'About' },
  { type: 'goals', text: 'Goals' },
  { type: 'our_vision', text: 'Our vision' },
  { type: 'our_services', text: 'Our services' },
  { type: 'why_us', text: 'Why us' },
...
export const sectionsData: Section[] = [
  ...
  },
  {
    ...
    image: "https://shebl9.azmy.aait-d.com/storage/images/Section/eaxxi4TVN86V0O46FnZvuVi2UKJJtHgyiMiKKSk2.png",
    icon: "https://shebl9.azmy.aait-d.com/dashboardAssets/images/cover/cover_sm.png",
    is_active: true,
    features: []
  },
